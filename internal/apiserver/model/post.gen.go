...
type PostM struct {
	...
	CreatedAt *time.Time `gorm:"column:createdAt;autoCreateTime;comment:博文创建时间" json:"createdAt"`   // 博文创建时间
	UpdatedAt *time.Time `gorm:"column:updatedAt;autoUpdateTime;comment:博文最后修改时间" json:"updatedAt"` // 博文最后修改时间
}
