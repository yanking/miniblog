...
type UserM struct {
	...
	CreatedAt *time.Time `gorm:"column:createdAt;autoCreateTime;comment:用户创建时间" json:"createdAt"`   // 用户创建时间
	UpdatedAt *time.Time `gorm:"column:updatedAt;autoUpdateTime;comment:用户最后修改时间" json:"updatedAt"` // 用户最后修改时间
}
